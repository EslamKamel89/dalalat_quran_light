...
import 'package:dalalat_quran_light/ui/single_word_widget.dart';
...
import 'package:dalalat_quran_light/utils/format_arabic_number.dart';
import 'package:dalalat_quran_light/utils/juz_names.dart';
...
import 'package:dalalat_quran_light/widgets/show_custom_dialog.dart';
          ...
          children.add(
            GestureDetector(
              ...
              onTap: () {
                ...
                // pr(pageLines[x][j]);
                // pr(pageLines[x][j].word_id, 'word_id');
                // pr(pageLines[x][j].ayaId, 'ayaId');
              ...
              onLongPress: () async {
                ...
                if (action == ShareOrReadAction.share) {
                  ...
                  String header =
                      ' الأية رقم ${formatArabicNumber(pageLines[x][j].ayaNo) ?? ''} في ${pageLines[x][j].suraName}\n';
                  ShareUtil.share(header: header, content: ayahAr, subject: header);
                }
