...
import 'package:dalalat_quran_light/ui/search_by_ayah/widgets/dropdown_item_card.dart';
import 'package:dalalat_quran_light/utils/print_helper.dart';
import 'package:dalalat_quran_light/utils/replace_arabic_numbers.dart';
      ...
      builder: (_) {
        return Padding(
          ...
          child: TypeAheadField<AyaModel>(
            emptyBuilder: (_) => DropdownItemDisplayCard(content: "no_data".tr),
