...
class MeaningTagsWidget extends StatefulWidget {
  const MeaningTagsWidget({super.key});

  @override
  State<MeaningTagsWidget> createState() => MeaningTagsWidgetState();
}

class MeaningTagsWidgetState extends State<MeaningTagsWidget> {
