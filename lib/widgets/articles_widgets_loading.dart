import 'package:dalalat_quran_light/widgets/custom_fading_widget.dart';
import 'package:flutter/material.dart';

class ArticlesWidgetLoadingColumn extends StatelessWidget {
  const ArticlesWidgetLoadingColumn({super.key});
