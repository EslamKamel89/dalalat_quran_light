...
import 'package:dalalat_quran_light/controllers/expain_dialog_controller.dart';
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  //       width: double.infinity,
                                  //     ),
                                  if (explanation != null && _isScrollable && _showFeedback)
                                    FeedbackTextWidget(
                                      onTap: () {
                                        Get.toNamed(
                                          AddCommentView.id,
