...
class SimilarWordModel {
  String? firstWord;
  String? secondWord;
  SimilarWordModel({this.firstWord, this.secondWord});

  Map<String, dynamic> toJson() {
    return <String, dynamic>{'word': firstWord, 'same_word': secondWord};
  }
  ...
  factory SimilarWordModel.fromJson(Map<String, dynamic> json) {
    return SimilarWordModel(
      ...
      secondWord:
          json['same_word'] != null ? json['same_word'] as String : null,
    );
  }

  @override
  String toString() =>
      'SimilarWordModel(firstWord: $firstWord, secondWord: $secondWord)';
}
